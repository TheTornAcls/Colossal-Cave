...
public static class Advent4Data
{
    ...
    [
        ...
        "#56",
        "Are you trying to find the cave?",
        "#57",
        ...
        "",
        "\t\tMinor corrections and conversions to MSC and C/370 by John W. Kennedy",
        "",
        "",
        ...
        "can be found anywhere but is frequently a sign of a deep pit leading down to",
        "water.",
        "#70",
        ...
        "#87",
        "I am prepared to offer you a hint, but it will cost you points.  Do you want",
        "the hint?",
        "#88",
        ...
        "#90",
        "Okay, from now on I'll only describe a place in full the first time you come to",
        "it.  To get the full description, say \"look\".",
        "#91",
        ...
        "save\").  To see how well you're doing, say \"score\".  To get full credit for a",
        ...
        "there is a large bonus just for getting in (to distinguish the beginners from",
        "the rest of the pack), and there are other ways to determine whether you've",
        "been through some of the more harrowing sections. If you think you've found",
        "all the treasures, just keep exploring for a while.  If nothing interesting",
        "happens, you haven't found them all yet.  If something interesting DOES",
        "happen, it means you're getting a bonus and have an opportunity to garner",
        "many more points in the master's section.  I may occasionally offer hints in",
        "you seem to be having trouble.\tIf I do, I'll warn you in advance how much it",
        "will affect your score to accept the hints.  Finally, to save paper, you may",
        "specify \"brief\", which tells me never to repeat the full description of a",
        "place unless you explicitly ask me to.",
        "#143",
        ...
        "I'd best hie meself off to the maze and hide me chest!\".  With that, he",
