...
public static class Advent1Data
{
    ...
    [
        ...
        "mist cover the floor of the pit, becoming thicker to the right.  Marks in the",
        ...
        "and another goes north.  To the south is a little passage 6 feet off the floor.",
        "#42",
        ...
        "Dead end",
        "#59",
        "You have crawled through a very low wide passage paralled to and north of the",
        "hall of mists.",
        "#60",
        ...
        "holes all over, but the only big one is on the wall directly over the west",
        ...
        "but they are now filled with boulders.\tLow small passages go north and",
        "south, and the south one quickly bends west around the boulders.",
        "#69",
        ...
        "passages go west and up.  The remnants of recent digging are evident.  A sign",
        "in midair here says:",
        ...
        "two- sided mirror is hanging paralled to and midway between the canyon",
        "walls.\t(The mirror is obviously provided for the use of the dwarves, who as",
        "you know, are extremely vain.)\tA small window can be seen in either wall,",
        "some fifty feet up.",
        "#110",
        "You're at a low window overlooking a huge pit, which extends up out of",
        "sight.\tA floor is indistinctly visible over 50 feet below.  Traces of white",
        ...
        "of which contains a little sulking bird.  In one corner is a bundle of black",
        "rods with rusty marks on their ends.  A large number of velvet pillows are",
        ...
        "below obscures all view of the far side.  A sw path leads away from the chasm",
        ...
        "You are in a secret canyon which exits to the north and east.",
        "#122",
        "You are on the far side of the chasm.  A ne path leads away from the chasm on",
        "this side.",
        "#123",
        ...
        "loud that the entire cave seems to be trembling.  Another passage leads",
        ...
        "cavern with a blood-red glare, giving everything an eerie, macabre",
