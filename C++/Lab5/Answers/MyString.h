...
public:
    ...
    // Lab 5: Destructor is now implemented as implicit inline
    ~CMyString()
    {
        delete [] m_pszBuffer;
    }
...
// Lab 5: Implement these "Get" functions as explicit inlines
...
// Lab 5: Turn all these non-member functions into "friend"
