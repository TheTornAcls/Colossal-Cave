// Test6A.cpp: Test program for Lab 6, Part 1
//
...
void main(void)
{
    ...
    // Lab 6, Part 1: Add try/catch block
    try
    {
        // Test Access Exception throw
        c.SetChar(79, '*');
        cout << "c.GetChar(79) is " << c.GetChar(79) << endl;
        char ch = c[90];
        cout << "This line will never be executed!" << endl;
    }
    catch (CMyStringAccessException& sae)
    {
        // Display information about the thrown exception
        cout << sae.what() << endl;
    }
